...
fun ArenaResponseDto.toArenaViewState(): ArenaViewState {
    ...
    return ArenaViewState(
        ...
        errors = errors,
        warnings = warnings,
        ownCount = plantations.size,
        enemyCount = enemy.size,
        constructionCount = construction.size,
        beaverCount = beavers.size,
        meteoCount = meteoForecasts.size,
        upgradePoints = plantationUpgrades?.points ?: 0,
        turnsUntilUpgrade = plantationUpgrades?.turnsUntilPoints,
        cells = mergedCells,
        entities = entities,
        alerts = alerts,
